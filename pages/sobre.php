...
<div class="row">
  <div class="column ">
    <div class="card zoom">
      <img src="data:image/jpeg;base64,<?php echo $imagem1?>" style="width:100%">
      <div class="container">
  ...
  <div class="column">
    <div class="card zoom">
      <img src="data:image/jpeg;base64,<?php echo $imagem2?>" style="width:100%">
      <div class="container">
  ...
  <div class="column ">
    <div class="card zoom">
      <img src="data:image/jpeg;base64,<?php echo $imagem3?>" style="width:100%">
      <div class="container">
